...
func (d *Docx) Translate() (err error) {
	oldString, err := encode(d.content)
	if err != nil {
		return err
	}
	fmt.Printf("orig %v", oldString)
	return err
	...
	translations, err := client.Translate(ctx, []string{oldString}, target, nil)
	if err != nil {
